...
angular.module("portal.directives").directive("disclosure", function () {
  return {
    restrict: "A",
    link: function (scope, element, attrs) {
      ...
      el.addEventListener("click", function (e) {
        if (e.target.className.indexOf("opener") == -1 && (e.target.tagName == "A" || e.target.getAttribute("data-details") != null)) {
          el.toggle(e);
        }
      });
