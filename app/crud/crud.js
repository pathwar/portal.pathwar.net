...
crud.config(function($stateProvider, formlyConfigProvider) {
  ...
  $stateProvider.state('crud', {
    url: '/crud/models',
    abstract: true,
    templateUrl: 'crud/views/main.tpl.html'
  })
  .state('crud.list', {
    url: '',
    controller: 'CrudListCtrl',
    templateUrl: 'crud/views/models.list.tpl.html'
  });
  ...
  .state('crud.model.list', {
    ...
    templateUrl: 'crud/views/list.tpl.html'
  })
  .state('crud.model.add', {
    url: '/add',
    controller: 'CrudModelsAddCtrl',
    templateUrl: 'crud/views/form.tpl.html'
  })
  .state('crud.model.view', {
    url: '/:id',
    controller: 'CrudModelsViewCtrl',
    templateUrl: 'crud/views/view.tpl.html'
  })
  ...
  formlyConfigProvider.setTemplateUrl(
    'text', 'crud/form-templates/formly-field-text.tpl.html'
  );
